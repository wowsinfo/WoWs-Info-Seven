...
export default language = new LocalizedStrings({
 en:{
    ...
    detail_module_title: 'Ship Modules',
    ...
    settings_support_title: 'Support development',
    settings_remove_ads: 'Remove ads',
    settings_restore_purchase: 'Restore purchases',
    settings_about_title: 'About',
    settings_email_feedback: 'Feedback',
    settings_email_feedback_sub: 'Send email to developer',
    settings_write_review: 'Rate this app',
    settings_share_app: 'Share with friends',
    settings_source_code: 'Source code',
    settings_source_code_sub: 'https://github.com/HenryQuan/React-Native-WoWs-Info',
    settings_open_source_library: 'Open source libraries',
    settings_support: 'Support development on Patreon',
 ...
 ja: {
   ...
   wiki_map: '地図',
   wiki_commander: 'Commander skill',
   wiki_collection: 'コレクション',
   filter_done: 'はい',
   filter_none: 'None',
   detail_status_title: '統計',
   detail_module_title: 'Ship Modules',
   detail_survivability: '抗堪性',
   survivability_health: 'HP',
   survivability_armour: '装甲',
   survivability_protection: 'Protection',
   detail_artillery: '砲',
   artillery_main: '主砲',
   artillery_secondary: '副砲',
   detail_torpedoes: '魚雷',
   detail_aa: '対空火力',
   detail_maneuverabilty: '機動性',
   detail_concealment: '隠蔽性',
   concealment_ship: '海面発見距離',
   concealment_plane: '航空発見距離',
   detail_aircraft: 'Aircraft',
   aircraft_fighter: 'Fighter',
   aircraft_torpedo_bomber: 'Torpedo Bomber',
   aircraft_bomber: 'Dive Bomber',
   ...
   search_title: 'WoWs Search',
   // Player
   player_max_damage_dealt: '最大与ダメージ',
   player_max_xp: '最大取得経験値',
   player_max_kill: '最大艦船撃沈',
   player_max_plane: '最大航空機撃墜',
   player_max_main_battery: '主砲',
   player_max_secondary: '副砲',
   player_max_torpedo: '魚雷',
   player_max_ramming: '体当たり',
   player_max_aircraft: '航空機',
   player_respect: 'Please respect everyone\nDo not judge other player by statistics',
   player_survival_rate: 'Survival\nRate',
   player_average_frag: 'Average\nFrag',
   player_powered_by_number: 'Powered by WoWs Numbers',
   ...
   rating_great: '超良い',
   rating_unicum: '素晴らしい',
   rating_super_unicum: 'スーパー素晴らしい',
   // Settings
   settings_theme_title: 'Theme',
   settings_theme: 'App theme',
   settings_language_title: '言語',
   settings_news_language: '情報の言語',
   settings_api_language: 'APIの言語',
   settings_support_title: 'Support development',
   settings_remove_ads: 'Remove ads',
   settings_restore_purchase: 'Restore purchases',
   settings_about_title: 'About',
   ...
   tool_assist: '[Android] Community Assistant',
   // Loading screen
   loading_welcome: 'WoWs Infoへようこそ',
   loading_welcome_back: 'Welcome back',
   loading_check_update: 'Updating...',
   loading_pr: 'Installing pr plugin',
   loading_ready: 'オールグリーン',
   // Extra
   no_information: '情報なし',
   no_internet: 'No Internet connection',
   iap_failed: 'Your purchase could not be completed',
