...
export default lang = new LocalizedStrings({
  en: {
    ...
    warship_artillery_main_reload: 'Reload Time',
    warship_artillery_main_range: 'Range',
    warship_artillery_main_guns: '#Guns',
    warship_artillery_main_dispersion: 'Max Dispersion',
    warship_artillery_main_rotation: 'Rotation Time',
    warship_artillery_main_fire_chance: 'Fire Chance',
    warship_artillery_main_weight: 'Weight',
    warship_artillery_main_damage: 'Citadel Damage',
    warship_artillery_main_velocity: 'Velocity',
