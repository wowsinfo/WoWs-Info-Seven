...
export const lang = new LocalizedStrings({
  en: {
    ...
    settings_app_write_review_message: 'This is for review only. If you have any questions, issues or suggestions, please send an email to the developer.',
    ...
    pro_50_off_until_re: '50% off for everyone until the next major update',
    pro_per_year: 'Year',
  ...
  zh: {
    ...
    settings_app_write_review_message: '如果有任何问题或者建议，请给开发者发送电子邮件。',
    ...
    pro_50_off_until_re: '到下一次大更新之前，可享受5折优惠',
    pro_per_year: '年',
  ...
  'zh-hant': {
    ...
    settings_app_write_review_message: '如果有任何問題或者建議，請給開發者發送電子郵件。',
    ...
    pro_50_off_until_re: '到下一次大更新之前，可享受5折優惠',
    pro_per_year: '年',
  ...
  ja: {
    ...
    settings_app_write_review_message: 'アプリについての問題や質問や意見などはメールで話しましょう',
    ...
    pro_50_off_until_re: '次のアップデートまでは５０％　OFF！',
    pro_per_year: '年',
