...
-(id)init
{
  if(self = [super init]) {
    ...
    [windowController setWindowFrameAutosaveName:@"WoWsInfoMac"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit WoWsInfoMac" action:@selector(terminate:) keyEquivalent:@"q"];
